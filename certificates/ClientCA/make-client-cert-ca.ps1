...
$caCertThumbprint = "7b3586b538f534ec412c5238383bd3efbf205967"  # Wprowadź tutaj thumbprint certyfikatu CA
...
$cert = New-SelfSignedCertificate -CertStoreLocation "cert:\LocalMachine\My" -KeyLength 2048 -KeyExportPolicy Exportable -NotAfter (Get-Date).AddYears(1) -Signer $caCertObject -Subject $subject -FriendlyName $friendlyName -KeyUsage DigitalSignature -TextExtension @("2.5.29.37={text}1.3.6.1.5.5.7.3.2", "2.5.29.17={text}$san", "2.5.29.19={text}CA=false")
